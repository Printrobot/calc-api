enum WorkStyle {
  Perfecting = 'Perfecting', // перфектор, переворот внутри машины через сторону подачи в машину, печать с двух сторон за цикл (4+4, 1+1, 2+2, 4+1, 5+2)
...
export function AlgImposition(params: AlgInput): AlgOutput {
  const result: AlgOutput = {
    ...
    complexityFactor: 2, // 1 - без оборота, 2 - чужой или свой
