// Резка листовой продукции в готовый фомат
...
export type ProcessInput = {     // получаем из других процессов в техкарте
  ...
  cutsOnOnePrintSheet: number // из спуска полос, как резать печатный лист на готовую продукцию
}
...
export function ProcessCalc(input: ProcessPropsInput): ProcessOutput {
  ...
  result.detail.cutsOnDetail = process.cutsOnOnePrintSheet; 
