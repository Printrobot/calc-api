// Брошюровка на спираль ("пружину" wire-O)
...
export type ProductionInput = {  // данные из UI, выбор клиента
    ...
    detailWireColor: string // цвет проволки
}
...
export type MaterialInput = {     // Какой артикул использовать зависит от толщины блока. 
  costWireOneMeter: number // Получаем из артикула материала. Цена метра проволки
}
